...
// ADR 0005 Amendment 8 §14 — implementation defaults. Frozen so callers
// cannot mutate the module-scope constants; per-call overrides flow via the
// `opts` argument to getOrComputeStreaming (used by tests to exercise caps
// cheaply without producing megabytes of fixture data).
export const PER_CLIENT_QUEUE_CAP_DEFAULT = Object.freeze({ value: 1 * 1024 * 1024 }).value;
export const ACCUMULATED_REPLAY_CAP_DEFAULT = Object.freeze({ value: 10 * 1024 * 1024 }).value;
